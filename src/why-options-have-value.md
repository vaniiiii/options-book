...
\\[ \Delta V \approx (\text{stock sensitivity}) \times \Delta S + (\text{time sensitivity}) \times \Delta t + (\text{vol sensitivity}) \times \Delta \sigma + (\text{rate sensitivity}) \times \Delta r \\]
